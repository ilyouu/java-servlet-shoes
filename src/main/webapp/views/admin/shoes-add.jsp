...
<head>
    ...
    <title>Thêm giày - Shoes Shop</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">THÊM GIÀY</h6>
                        </div>
                        <div class="card-body">
                            <form class="user" action="admin-shoes-add" method="POST">
                    			<div class="form-group">
                                    <input placeholder="Tên giày" name="ten_giay" type="text" class="form-control form-control-user" >
                                </div>
                               	<div class="form-group">
                                    <input placeholder="Loại giày" name="ten_loai_giay" type="text" class="form-control form-control-user" >
                                </div>
                                <div class="form-group">
                                    <input placeholder="Thương hiệu" name="ten_thuong_hieu" type="text" class="form-control form-control-user" >
                                </div>
                                <div class="form-group">
                                    <textarea placeholder="Mô tả" type="input" class="form-control form-control-user" name="mo_ta" autocomplete="off" id="ckediter" /></textarea>
                                </div>
                                <div class="form-group">
                                    <input placeholder="Đơn giá" name="don_gia" type="text" class="form-control form-control-user" >
                                </div>
